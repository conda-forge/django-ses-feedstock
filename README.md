...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/django-ses-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9868&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/django-ses-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `django-ses` can be installed with:

```
conda install django-ses
```

It is possible to list all of the versions of `django-ses` available on your platform with:
